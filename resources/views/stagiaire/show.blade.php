...
<body>
    <div style="margin: 25px">
        <a href="{{ route('stagiaire.index') }}" class="btn btn-secondary" style="margin-left: 200px">Retour</a>
        ...
        <div class="div-table-container" id="printContent">
            ...
            <div style="margin: 25px; text-align: right;">
                <p>Fait à Fès, le: <input type="date" name="" id="dateInput" value="{{ date('Y-m-d') }}"><br>Signature et cachet de l'entreprise</p>
            </div>
    ...
    <script>
        function printContent() {
            ...
            content.querySelector('#dateInput').outerHTML = '<span>' + dateValue + '</span>';
            ...
            printWindow.document.write('<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css" integrity="sha512-DTOQO9RWCH3ppGqcWaEA1BIZOC6xxalwEsw9c2QQeAIftl+Vegovlnee1c9QX4TctnWMn13TZye+giMm8e2LwA==" crossorigin="anonymous" referrerpolicy="no-referrer" />');
